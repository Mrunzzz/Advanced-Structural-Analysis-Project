...
% 
% MD_estiff.m computes the element stiffness matrix for a given element with first node flexurally released
%
...
elk_temp(:, 12) = E * Izz * [zeros(11, 1); (L ^ 2/4 + etay)] / (L * (L ^ 2/12 + etay));
